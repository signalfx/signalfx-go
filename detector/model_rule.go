...
type Rule struct {
	...
	// SkipClearNotificationStates allows the user to configure for what incident clearing states detector will not fire clearing notifications. Valid values: OK, AUTO_RESOLVED, STOPPED, MANUALLY_RESOLVED.
	SkipClearNotificationStates []string `json:"skipClearNotificationStates,omitempty"`
}
