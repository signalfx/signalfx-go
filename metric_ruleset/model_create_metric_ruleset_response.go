...
func (o *CreateMetricRulesetResponse) GetExceptionRules() []ExceptionRule {
...
// and a boolean to check if the value has been set.
func (o *CreateMetricRulesetResponse) GetExceptionRulesOk() ([]ExceptionRule, bool) {
	if o == nil || isNil(o.ExceptionRules) {
		return nil, false
	}
...
func (o *CreateMetricRulesetResponse) HasExceptionRules() bool {
	if o != nil && !isNil(o.ExceptionRules) {
		return true
	}
...
func (o *CreateMetricRulesetResponse) SetExceptionRules(v []ExceptionRule) {
	o.ExceptionRules = v
}
