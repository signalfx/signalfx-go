...
func (o *GetMetricRulesetResponse) GetExceptionRules() []ExceptionRule {
...
// and a boolean to check if the value has been set.
func (o *GetMetricRulesetResponse) GetExceptionRulesOk() ([]ExceptionRule, bool) {
	if o == nil || isNil(o.ExceptionRules) {
		return nil, false
	}
...
func (o *GetMetricRulesetResponse) HasExceptionRules() bool {
	if o != nil && !isNil(o.ExceptionRules) {
		return true
	}
...
func (o *GetMetricRulesetResponse) SetExceptionRules(v []ExceptionRule) {
	o.ExceptionRules = v
}
...
func (o *GetMetricRulesetResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *GetMetricRulesetResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
		return nil, false
	}
...
func (o *GetMetricRulesetResponse) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *GetMetricRulesetResponse) SetDescription(v string) {
	o.Description = &v
}
