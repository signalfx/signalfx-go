...
func (o *MetricRuleset) GetExceptionRules() []ExceptionRule {
...
// and a boolean to check if the value has been set.
func (o *MetricRuleset) GetExceptionRulesOk() ([]ExceptionRule, bool) {
	if o == nil || isNil(o.ExceptionRules) {
		return nil, false
	}
...
func (o *MetricRuleset) HasExceptionRules() bool {
	if o != nil && !isNil(o.ExceptionRules) {
		return true
	}
...
func (o *MetricRuleset) SetExceptionRules(v []ExceptionRule) {
	o.ExceptionRules = v
}
...
func (o *MetricRuleset) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *MetricRuleset) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
		return nil, false
	}
...
func (o *MetricRuleset) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *MetricRuleset) SetDescription(v string) {
	o.Description = &v
}
