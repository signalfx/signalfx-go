...
func (o *UpdateMetricRulesetResponse) GetExceptionRules() []ExceptionRule {
...
// and a boolean to check if the value has been set.
func (o *UpdateMetricRulesetResponse) GetExceptionRulesOk() ([]ExceptionRule, bool) {
	if o == nil || isNil(o.ExceptionRules) {
		return nil, false
	}
...
func (o *UpdateMetricRulesetResponse) HasExceptionRules() bool {
	if o != nil && !isNil(o.ExceptionRules) {
		return true
	}
...
func (o *UpdateMetricRulesetResponse) SetExceptionRules(v []ExceptionRule) {
	o.ExceptionRules = v
}
...
func (o *UpdateMetricRulesetResponse) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateMetricRulesetResponse) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
		return nil, false
	}
...
func (o *UpdateMetricRulesetResponse) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *UpdateMetricRulesetResponse) SetDescription(v string) {
	o.Description = &v
}
