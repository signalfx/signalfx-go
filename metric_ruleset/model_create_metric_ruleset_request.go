...
func (o *CreateMetricRulesetRequest) GetExceptionRules() []ExceptionRule {
...
// and a boolean to check if the value has been set.
func (o *CreateMetricRulesetRequest) GetExceptionRulesOk() ([]ExceptionRule, bool) {
	if o == nil || isNil(o.ExceptionRules) {
		return nil, false
	}
...
func (o *CreateMetricRulesetRequest) HasExceptionRules() bool {
	if o != nil && !isNil(o.ExceptionRules) {
		return true
	}
...
func (o *CreateMetricRulesetRequest) SetExceptionRules(v []ExceptionRule) {
	o.ExceptionRules = v
}
...
func (o *CreateMetricRulesetRequest) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *CreateMetricRulesetRequest) GetDescriptionOk() (*string, bool) {
	if o == nil || isNil(o.Description) {
		return nil, false
	}
...
func (o *CreateMetricRulesetRequest) HasDescription() bool {
	if o != nil && !isNil(o.Description) {
		return true
	}
...
func (o *CreateMetricRulesetRequest) SetDescription(v string) {
	o.Description = &v
}
